...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> authorizationExc (AuthorizationException e, HttpServletRequest request){
	...
	public ResponseEntity<StandardError> amazonServiceExc (AmazonServiceException e, HttpServletRequest request){
	...
	public ResponseEntity<StandardError> amazonClientExc (AmazonClientException e, HttpServletRequest request){
	...
	public ResponseEntity<StandardError> amazonS3Exc (AmazonS3Exception e, HttpServletRequest request){
